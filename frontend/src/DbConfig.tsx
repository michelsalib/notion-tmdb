...
export function DbConfig({
  ...
  onConfigChange: (dbConfig: UserConfig["dbConfig"]) => any;
}) {
  ...
  const database = notionDatabases.find(
    (db) => db.id == config.id,
  ) as UserConfig["notionDatabases"][0];
      ...
      {!urlColumns.length || !statusColumns.length ? (
        ...
        <Fragment>
          ...
          <FormControl required>
            ...
            <FormHelperText>
              This mandatory field helps associate your entry with a TMDB movie
            </FormHelperText>
          </FormControl>
          ...
          <FormControl required>
            ...
            <Select
              ...
              value={config.status}
              onChange={(event) =>
                setConfig({ ...config, status: event.target.value })
              }
            >
              {columns.map((property: any) => (
                <MenuItem
            ...
            <FormHelperText>
              This mandatory field helps the plugin to identify your entires
          ...
          <FormControl>
            ...
            <Select
              ...
              onChange={(event) =>
                setConfig({ ...config, director: event.target.value })
              }
            >
              <MenuItem value="">
                <em>None</em>
              ...
              {columns.map((property: any) => (
                <MenuItem
                  value={property.id}
                  key={property.id}
                  disabled={property.type != "rich_text"}
                >
                  {typeToEmoji(property.type)} {property.name}
                </MenuItem>
              ))}
          ...
          <FormControl>
            ...
            <Select
              ...
              value={config.year}
              onChange={(event) =>
                setConfig({ ...config, year: event.target.value })
              }
            >
              <MenuItem value="">
                <em>None</em>
          ...
          <FormControl>
            ...
            <Select
              ...
              value={config.genre}
              onChange={(event) =>
                setConfig({ ...config, genre: event.target.value })
              }
            >
              <MenuItem value="">
                <em>None</em>
              ...
              {columns.map((property: any) => (
                <MenuItem
                  value={property.id}
                  key={property.id}
                  disabled={property.type != "multi_select"}
                >
                  {typeToEmoji(property.type)} {property.name}
                </MenuItem>
              ))}
          ...
          <FormControl>
            ...
            <Select
              ...
              value={config.rating}
              onChange={(event) =>
                setConfig({ ...config, rating: event.target.value })
              }
            >
              <MenuItem value="">
                <em>None</em>
