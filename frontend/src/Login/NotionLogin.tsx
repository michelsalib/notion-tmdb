...
export function NotionLogin() {
  ...
  return (
    // Contained: this is the page's one call to action, and `outlined` is now
    // the neutral treatment reserved for secondary paths.
    <Button variant="contained" size="large" onClick={login}>
      <SvgIcon sx={{ marginRight: 1, fontSize: 18 }}>
        <svg
